...
func (_u *PostUpdate) SetSubject(v string) *PostUpdate {
	_u.mutation.SetSubject(v)
	return _u
}

// SetNillableSubject sets the "subject" field if the given value is not nil.
func (_u *PostUpdate) SetNillableSubject(v *string) *PostUpdate {
	if v != nil {
		_u.SetSubject(*v)
	}
	return _u
...
func (_u *PostUpdate) check() error {
	...
	if _u.mutation.AuthorCleared() && len(_u.mutation.AuthorIDs()) > 0 {
		return errors.New(`models: clearing a required unique edge "Post.author"`)
	}
	return nil
}
...
// SetSubject sets the "subject" field.
func (_u *PostUpdateOne) SetSubject(v string) *PostUpdateOne {
	_u.mutation.SetSubject(v)
	return _u
}

// SetNillableSubject sets the "subject" field if the given value is not nil.
func (_u *PostUpdateOne) SetNillableSubject(v *string) *PostUpdateOne {
	if v != nil {
		_u.SetSubject(*v)
	}
	return _u
