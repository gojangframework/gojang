...
3. Executes migrations from the `app/gojang/models/migrations/` directory
4. Keeps track of which migrations have been applied

## Migration Files

Migration files are located in `app/gojang/models/migrations/` and follow this naming pattern:
...
- `github.com/golang-migrate/migrate/v4/source/iofs` - Embedded migration source driver
